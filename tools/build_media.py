...
CLIPS = [
    # source is 512x768 (2:3), not the old 720x1280 (9:16) — output kept at
    # the source's own aspect (720x1080) so the matte is never stretched
    ("hero", "v1.mp4", "v1", 720, 1080, 0, 105),
...
def build_grunge():
    """Lift the distressed surface out of the supplied SAKSHAM artwork.
